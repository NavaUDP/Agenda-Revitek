          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <button 
                  className="w-full bg-primary text-primary-foreground hover:bg-primary/90 py-2 px-4 rounded text-sm transition-colors flex items-center justify-center space-x-2"
                ...
                <button 
                  className="w-full border border-primary text-primary hover:bg-primary hover:text-primary-foreground py-2 px-4 rounded text-sm transition-colors"
